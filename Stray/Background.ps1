...
$gameExecutableName = "Stray.exe" # executable name should be structured, "GAME NAME.exe"
$gameFolderName = "Stray" # install folder should be structured like this, "GAME FOLDER NAME" just give the folder name
$gameSaveFolder = "$env:LOCALAPPDATA\Hk_project" # the folder where saves are located, if the game does not store save files in a folder comment this out-
...
# -enviorment varables instead.
$gameSaveExtentions = ".sav" # the game save folder sometimes contains information other than just game saves, and some-
